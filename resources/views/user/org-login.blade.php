        ...
        <div class="container">
            ...
            <div class=" box row m-5 no-gutters shadow-lg" style="background-color: #CCCCCC; border-radius: 10px">
                <div class="col-md-5 d-none d-md-block">
                    <img src="assets/images/acc/orgn.jpg" class="img-fluid" style="min-height:100%;" />
                </div>
                <div class="col-md-6 p-5" style="background-color: #CCCCCC; border-radius: 10px">
                    <h3 class="pb-3">Organization Login Form</h3>
                    <div class="form-style">
                        <form action="{{ route('user.org-login') }}" method="post">
                            @csrf
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                {{-- <div class="d-flex align-items-center"><input name="" type="checkbox"
                                        value="" /> <span class="pl-2 font-weight-bold">Remember Me</span></div> --}}
                        ...
                        <div class="pt-4 text-center">
                            Get Members Benefit. <a href="{{ route('user.org-signup') }}">Sign Up</a>
                        </div>
                    </div>
