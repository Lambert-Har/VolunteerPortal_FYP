...
@section('content')
    ...
    <body>
        ...
        <p class="text-center mb-5" style="background-color: rgb(255, 230, 0);">⚠ Note that if you refresh/leave this page whithout
            confirming your
            phone number,<br> you will be able to register again after 5 minutes
        </p>
        {{-- @if (session('message'))
        ...
        <div class="container shadow-lg mb-5">
            ...
            <form action="{{ route('user.vol-verification') }}" method="post">
                @csrf
