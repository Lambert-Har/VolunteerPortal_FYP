    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li class="active"><a href="{{ route('org.community') }}"><i class='bx bx-group'></i>Community</a></li>
            ...
            <main>
                <div id="scroll-container" class="bottom-data "
                    ...
                    <div class="orders">
                        @foreach ($allPosts as $post)
                            <div class="message-container">
                                <div class=" mb-3 ">
                                    ...
                                    <div>
                                        <p class="mb-5 mt-1" style="margin-left: 38px"
                                            style="font-size: 15px;position: inherit;">
                                            {{ $post->content }}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('community.orgpost') }}" method="POST">
                            @csrf
